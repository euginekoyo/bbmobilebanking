...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PINRESETHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PINRESETHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PINRESETHISTORY actions', async () => {
      const arg = { id: 16824 };
    ...
    it('dispatches UPDATE_PINRESETHISTORY actions', async () => {
      const arg = { id: 16824 };
    ...
    it('dispatches PARTIAL_UPDATE_PINRESETHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PINRESETHISTORY actions', async () => {
      const arg = 42666;
