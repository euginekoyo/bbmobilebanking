...
public class SPSOutgoingTransactionsAsserts {
    ...
    public static void assertSPSOutgoingTransactionsUpdatableFieldsEquals(
        ...
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getCallbackstatus()).as("check callbackstatus").isEqualTo(actual.getCallbackstatus()))
            .satisfies(e -> assertThat(e.getCallbackstatusdesc()).as("check callbackstatusdesc").isEqualTo(actual.getCallbackstatusdesc()));
    }
