...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './range.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RANGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RANGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RANGE actions', async () => {
      const arg = { id: 20011 };
    ...
    it('dispatches UPDATE_RANGE actions', async () => {
      const arg = { id: 20011 };
    ...
    it('dispatches PARTIAL_UPDATE_RANGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RANGE actions', async () => {
      const arg = 42666;
