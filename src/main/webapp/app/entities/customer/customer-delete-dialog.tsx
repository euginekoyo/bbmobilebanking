...
export const CUSTOMERDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="bbMobileBankingAdminApp.cUSTOMER.delete.question">
        <Translate contentKey="bbMobileBankingAdminApp.cUSTOMER.delete.question" interpolate={{ id: cUSTOMEREntity.id }}>
