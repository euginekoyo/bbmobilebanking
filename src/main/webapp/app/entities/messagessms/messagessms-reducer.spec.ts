...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MESSAGESSMS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MESSAGESSMS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MESSAGESSMS actions', async () => {
      const arg = { id: 1040 };
    ...
    it('dispatches UPDATE_MESSAGESSMS actions', async () => {
      const arg = { id: 1040 };
    ...
    it('dispatches PARTIAL_UPDATE_MESSAGESSMS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MESSAGESSMS actions', async () => {
      const arg = 42666;
