...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MESSAGETEMPLATES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MESSAGETEMPLATES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MESSAGETEMPLATES actions', async () => {
      const arg = { id: 12480 };
    ...
    it('dispatches UPDATE_MESSAGETEMPLATES actions', async () => {
      const arg = { id: 12480 };
    ...
    it('dispatches PARTIAL_UPDATE_MESSAGETEMPLATES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MESSAGETEMPLATES actions', async () => {
      const arg = 42666;
