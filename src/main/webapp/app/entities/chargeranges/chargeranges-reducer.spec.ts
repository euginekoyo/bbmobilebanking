...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHARGERANGES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHARGERANGES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHARGERANGES actions', async () => {
      const arg = { id: 4849 };
    ...
    it('dispatches UPDATE_CHARGERANGES actions', async () => {
      const arg = { id: 4849 };
    ...
    it('dispatches PARTIAL_UPDATE_CHARGERANGES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHARGERANGES actions', async () => {
      const arg = 42666;
