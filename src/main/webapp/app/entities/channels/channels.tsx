  ...
  return (
    <div>
      <h2 id="channels-heading" data-cy="CHANNELSHeading">
        <Translate contentKey="bbMobileBankingAdminApp.cHANNELS.home.title">CHANNELS</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="bbMobileBankingAdminApp.cHANNELS.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/channels/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="bbMobileBankingAdminApp.cHANNELS.home.createLabel">Create new CHANNELS</Translate>
          </Link>
        </div>
      </h2>
        ...
        {cHANNELSList && cHANNELSList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="bbMobileBankingAdminApp.cHANNELS.id">ID</Translate>{' '}
                ...
                <th className="hand" onClick={sort('bIN')}>
                  <Translate contentKey="bbMobileBankingAdminApp.cHANNELS.bIN">B IN</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('bIN')} />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="bbMobileBankingAdminApp.cHANNELS.home.notFound">No CHANNELS found</Translate>
            </div>
          )
        )}
      </div>
