 ...
 */
@Entity
@Table(name = "`SPSOutgoingTransactions`")
...
public class SPSOutgoingTransactions implements Serializable {
    ...
    @Size(max = 28)
    @Column(name = "`MESSAGE_TYPE`", length = 28)
    ...
    @Size(max = 18)
    @Column(name = "`DEBTORS_BANKCODE`", length = 18)
    private String debtorsbankcode;

    @Size(max = 19)
    @Column(name = "`DEBTORS_PHONE`", length = 19)
    ...
    @Size(max = 19)
    @Column(name = "`BENEFICIARY_BANKCODE`", length = 19)
    private String beneficiarybankcode;

    @Size(max = 19)
    @Column(name = "`BENEFICIARY_PHONE`", length = 19)
    ...
    @Size(max = 19)
    @Column(name = "`TRANSACTION_STATUS`", length = 19)
    ...
    @Size(max = 19)
    @Column(name = "`SPS_STATUS`", length = 19)
    ...
    @Size(max = 19)
    @Column(name = "`CBS_STATUS`", length = 19)
    ...
    @Size(max = 29)
    @Column(name = "`ISO_MESSAGETYPE`", length = 29)
    ...
    @Size(max = 10)
    @Column(name = "`CALLBACK_STATUS`", length = 10)
    private String callbackstatus;

    @Size(max = 100)
    @Column(name = "`CALLBACK_STATUS_DESC`", length = 100)
