...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LINKEDACCOUNTS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LINKEDACCOUNTS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LINKEDACCOUNTS actions', async () => {
      const arg = { id: 30552 };
    ...
    it('dispatches UPDATE_LINKEDACCOUNTS actions', async () => {
      const arg = { id: 30552 };
    ...
    it('dispatches PARTIAL_UPDATE_LINKEDACCOUNTS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LINKEDACCOUNTS actions', async () => {
      const arg = 42666;
