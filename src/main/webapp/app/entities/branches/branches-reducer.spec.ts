...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './branches.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BRANCHES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BRANCHES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BRANCHES actions', async () => {
      const arg = { id: 13847 };
    ...
    it('dispatches UPDATE_BRANCHES actions', async () => {
      const arg = { id: 13847 };
    ...
    it('dispatches PARTIAL_UPDATE_BRANCHES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BRANCHES actions', async () => {
      const arg = 42666;
