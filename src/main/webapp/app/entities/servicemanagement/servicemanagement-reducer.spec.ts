...
import reducer, {
  ...
  reset,
  updateEntity,
} from './servicemanagement.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVICEMANAGEMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SERVICEMANAGEMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SERVICEMANAGEMENT actions', async () => {
      const arg = { id: 14603 };
    ...
    it('dispatches UPDATE_SERVICEMANAGEMENT actions', async () => {
      const arg = { id: 14603 };
    ...
    it('dispatches PARTIAL_UPDATE_SERVICEMANAGEMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SERVICEMANAGEMENT actions', async () => {
      const arg = 42666;
