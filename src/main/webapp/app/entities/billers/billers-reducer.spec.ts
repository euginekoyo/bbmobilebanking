...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './billers.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BILLERS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BILLERS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BILLERS actions', async () => {
      const arg = { id: 31440 };
    ...
    it('dispatches UPDATE_BILLERS actions', async () => {
      const arg = { id: 31440 };
    ...
    it('dispatches PARTIAL_UPDATE_BILLERS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BILLERS actions', async () => {
      const arg = 42666;
