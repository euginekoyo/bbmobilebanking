      ...
      <div class="row gx-5 align-items-center">
        <div class="col-lg-6">
          ...
          <div class="mb-5 mb-lg-0 text-center text-lg-start">
            <h1 class="display-1 lh-1 mb-3">Bushra Bank Admin Portal.</h1>
            <p class="lead fw-normal text-muted mb-5">Secure, seamless, and built for modern banking operations.!</p>
            <div class="d-flex flex-column flex-lg-row align-items-center">
              <a class="me-lg-3 mb-4 mb-lg-0" href="#!">
                <img class="app-badge" src="/content/images/google-play-badge.svg" alt="..." />
              </a>
              <a href="#!">
                <img class="app-badge" src="/content/images/app-store-badge.svg" alt="..." />
              </a>
            </div>
          </div>
        </div>
        <div class="col-lg-6">
          ...
          <div class="masthead-device-mockup">
            ...
            <div class="device-wrapper">
              <div class="device" data-device="iPhoneX" data-orientation="portrait" data-color="black"></div>
            </div>
          </div>
        </div>
      </div>
...
:root {
  ...
  --bs-body-font-family: Mulish, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif, Apple Color Emoji,
...
.form-range:focus::-webkit-slider-thumb {
  box-shadow:
    0 0 0 1px #fff,
    0 0 0 0.25rem rgba(41, 55, 240, 0.25);
}
...
.device[data-device='iPhoneX'][data-orientation='portrait'][data-color='black']::after {
  content: '';
  background-image: url('../../content/images/portrait_black.png');
}

.landingpage1 {
  height: 100%;
  background: url('../../content/images/landingpage1.png') no-repeat center center;
  background-size: contain;
  width: 100%;
