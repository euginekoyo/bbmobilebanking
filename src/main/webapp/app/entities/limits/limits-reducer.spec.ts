...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './limits.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIMITS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LIMITS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LIMITS actions', async () => {
      const arg = { id: 32168 };
    ...
    it('dispatches UPDATE_LIMITS actions', async () => {
      const arg = { id: 32168 };
    ...
    it('dispatches PARTIAL_UPDATE_LIMITS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LIMITS actions', async () => {
      const arg = 42666;
