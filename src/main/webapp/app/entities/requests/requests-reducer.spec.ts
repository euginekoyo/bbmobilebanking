...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './requests.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REQUESTS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REQUESTS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REQUESTS actions', async () => {
      const arg = { id: 15120 };
    ...
    it('dispatches UPDATE_REQUESTS actions', async () => {
      const arg = { id: 15120 };
    ...
    it('dispatches PARTIAL_UPDATE_REQUESTS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REQUESTS actions', async () => {
      const arg = 42666;
