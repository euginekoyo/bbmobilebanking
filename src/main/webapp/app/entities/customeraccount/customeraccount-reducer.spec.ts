...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUSTOMERACCOUNT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CUSTOMERACCOUNT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CUSTOMERACCOUNT actions', async () => {
      const arg = { id: 14880 };
    ...
    it('dispatches UPDATE_CUSTOMERACCOUNT actions', async () => {
      const arg = { id: 14880 };
    ...
    it('dispatches PARTIAL_UPDATE_CUSTOMERACCOUNT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CUSTOMERACCOUNT actions', async () => {
      const arg = 42666;
